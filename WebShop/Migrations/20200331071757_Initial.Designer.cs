...
namespace WebShop.Migrations
{
    ...
    [Migration("20200331071757_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebShop.Models.Anh", b =>
                {
                    b.Property<int>("Masp")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("MASP")
            ...
            modelBuilder.Entity("WebShop.Models.Chitiethoadon", b =>
                {
                    b.Property<int>("Mahd")
                        .HasColumnName("MAHD")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebShop.Models.Hang", b =>
                {
            ...
            modelBuilder.Entity("WebShop.Models.Hoadon", b =>
                {
                    b.Property<int>("Mahd")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("MAHD")
            ...
            modelBuilder.Entity("WebShop.Models.Khachhang", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("ID")
            ...
            modelBuilder.Entity("WebShop.Models.Magiamgia", b =>
                {
            ...
            modelBuilder.Entity("WebShop.Models.Sanpham", b =>
                {
                    b.Property<int>("Masp")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("MASP")
            ...
            modelBuilder.Entity("WebShop.Models.Users", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnName("ID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebShop.Models.Anh", b =>
                {
                    b.HasOne("WebShop.Models.Sanpham", "MaspNavigation")
                        .WithMany("Anh")
                        .HasForeignKey("Masp")
            ...
            modelBuilder.Entity("WebShop.Models.Hoadon", b =>
                {
                    b.HasOne("WebShop.Models.Khachhang", "IdkhNavigation")
                        .WithMany("Hoadon")
                        .HasForeignKey("Idkh")
            ...
            modelBuilder.Entity("WebShop.Models.Sanpham", b =>
                {
                    b.HasOne("WebShop.Models.Hang", "HangNavigation")
                        .WithMany("Sanpham")
                        .HasForeignKey("Hang")
